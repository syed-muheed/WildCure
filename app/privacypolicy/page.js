  ...
  return (
    ...
    <Padding className={"py-[5rem] text-[#79797B] lg:flex gap-4 font-medium"}>
      ...
      <Padding className="border xl:w-[80%] border-[#E7EBED] rounded-[1.2rem] py-[2rem] font-monserrat">
        ...
        <div className="text-[#595959] pt-6">
          At Wildcure Pharma, we respect your privacy and are committed to
        ...
        <div className="pt-5 space-y-7">
          ...
          <div className=" space-y-3">
            <div className="text-[#232323]">Personal Information</div>
            <div>
              Name, email address, phone number, company information, job title,
              and business address when you register, place an order, or contact
              us.
            </div>
          </div>
          <div className=" space-y-3">
            <div className="text-[#232323]">Usage Data</div>
            <div>
              Information about how you access and use our website, including IP
              address, browser type, device information, pages visited, and time
              spent on our site.
            </div>
          </div>
          <div className=" space-y-3">
            <div className="text-[#232323]">Communications</div>
            <div>
              Records of correspondence when you contact us, including inquiries
          ...
          <div className=" space-y-3">
            ...
            <ul
              className=" pl-[20px] space-y-2"
              style={{ listStyleType: "disc" }}
            >
              <li>Process and fulfill your orders</li>
              <li>Provide customer support</li>
              <li>
                Send you important updates about our products, services, and
                company
              </li>
          ...
          <div className=" space-y-3">
            <div className="text-[#232323]">Data Protection</div>
            <div>
              Wildcure Pharma implements appropriate security measures to
              protect your personal information against unauthorized access,
              alteration, disclosure, or destruction. As a pharmaceutical
              company, we understand the sensitive nature of information in our
              industry and maintain stringent data protection protocols.{" "}
            </div>
          </div>
          <div className=" space-y-3">
            <div className="text-[#232323]">Third-Party Disclosure</div>
          ...
          <div className=" space-y-3">
            <div className="text-[#232323]">International Data Transfers</div>
            <div>
              As a global company based in Hyderabad, India, we may transfer
              your information to countries outside your home country. We ensure
