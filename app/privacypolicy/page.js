      ...
      <Padding className={"py-[5rem] text-[#79797B] lg:flex gap-4 font-medium"}>
        ...
        <Padding className="border xl:w-[80%] border-[#E7EBED] rounded-[1.2rem] py-[2rem] font-monserrat">
          ...
          <div className="text-[#595959] pt-6">
            ...
            you visit our website, use our services, or engage with us in any
            way.
          </div>
          <div className="pt-5 space-y-7">
            ...
            <div className=" space-y-3">
              <div className="text-[#232323]">Personal Information</div>
              <div>
                Name, email address, phone number, company information, job
                title, and business address when you register, place an order,
                or contact us.
              </div>
            </div>
            <div className=" space-y-3">
            ...
            <div className=" space-y-3">
              <div className="text-[#232323]">Communications</div>
              <div>
                Records of correspondence when you contact us, including
            ...
            <div className=" space-y-3">
              ...
              <div>
                ...
                company, we understand the sensitive nature of information in
                our industry and maintain stringent data protection protocols.{" "}
              </div>
            </div>
            <div className=" space-y-3">
              <div className="text-[#232323]">Third-Party Disclosure</div>
            ...
            <div className=" space-y-3">
              ...
              <div>
                ...
                your information to countries outside your home country. We
