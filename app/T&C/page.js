        ...
        <Padding className="border xl:w-[80%] border-[#E7EBED] rounded-[1.2rem] py-[2rem] font-monserrat">
          ...
          <div className="pt-5 space-y-7">
            <div className=" space-y-3">
              <div className="text-[#232323]">Acceptance of Terms</div>
              <div>
                By accessing and using Wildcure Pharma's website and services,
                you agree to be bound by these Terms of Use. If you do not agree
                with any part of these terms, you may not access our website or
                use our services.
              </div>
            </div>
            <div className=" space-y-3">
              ...
              <div>
                ...
                Wildcure Pharma and is protected by intellectual property laws.
            ...
            <div className=" space-y-3">
              ...
              <div>
                ...
                product descriptions or other content is error-free. All
                products must be used in accordance with applicable regulations
                and guidelines.
              </div>
            </div>
            <div className=" space-y-3">
              ...
              <div>
                ...
                they have appropriate licenses and permissions to import,
                handle, and use our pharmaceutical ingredients in their
                jurisdiction.
              </div>
            </div>
            <div className=" space-y-3">
            ...
            <div className=" space-y-3">
              <div className="text-[#232323]">Changes to Terms</div>
              <div>
                Wildcure Pharma reserves the right to modify these Terms of Use
